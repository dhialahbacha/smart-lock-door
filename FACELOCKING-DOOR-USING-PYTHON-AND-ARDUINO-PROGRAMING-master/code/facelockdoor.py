...
d=0
while q<=2:
    data_path = 'C:\\Users\\bazinfo\\Desktop\\FACELOCKING-DOOR-USING-PYTHON-AND-ARDUINO-PROGRAMING-master\\image\\'
    ...
    q+=1
face_classifier = cv2.CascadeClassifier('C:\\Users\\bazinfo\\Desktop\\FACELOCKING-DOOR-USING-PYTHON-AND-ARDUINO-PROGRAMING-master\\requirements\\haarcascade_frontalface_default.xml')
...
if x>=5:
    ...
    print("face is not matching..please try again")
elif d==20:
    speak("face is not found please try again ")
    print("face is not found please try again")
if m==1:  
